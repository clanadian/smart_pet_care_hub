...
/* Private defines -----------------------------------------------------------*/
#define EMG_BUTTON_Pin GPIO_PIN_13
#define EMG_BUTTON_GPIO_Port GPIOC
#define EMG_BUTTON_EXTI_IRQn EXTI15_10_IRQn
...
#define IR_REMOTE_Pin GPIO_PIN_0
#define IR_REMOTE_GPIO_Port GPIOA
#define IR_REMOTE_EXTI_IRQn EXTI0_IRQn
